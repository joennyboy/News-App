...
public class NewsInfoService extends AsyncTaskLoader<List<NewsInfo>> {

    private final static String LOG_TAG = NewsInfoService.class.getSimpleName();
    ...
    public NewsInfoService(Context context) {
        super(context);
    }
    ...
    public List<NewsInfo> loadInBackground() {
        List<NewsInfo> listOfNews;
        String reponseStr = makeHttpRequest(getUri());
        listOfNews = parseJson(reponseStr);
        return listOfNews;
    }

    private ArrayList<NewsInfo> parseJson(String bookJsonStr) {
        ArrayList<NewsInfo> bookArrayList = new ArrayList<>();
        ...
        try {
            ...
            if (null != newsJsonArray && newsJsonArray.length() > 0) {
                ...
                for (int i = 0; i < newsJsonArray.length(); i++) {
                    ...
                    bookArrayList.add(new NewsInfo(
    ...
    private String getUriBuilder() {
        return new Uri.Builder()
                ...
                .appendQueryParameter("api-key", "0666bf3d-4f85-49e9-8e22-fc1cfc086505")
                .build()
                .toString();
    }
}